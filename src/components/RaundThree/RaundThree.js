        ...
        {(buttle === 1 && (
          <div className={styles.textBot}>
            <p>
              ...
              побеждать, не знаю что он и кому доказывал, но явно не нам с тобой
              !
            </p>
          </div>
        )) ||
          ...
          (buttle === 20 && (
            <div className={styles.textBotInGameTwo}>
              <p>
                Это же нечестно ! Мы обречены... Хотя постой, кажется я знаю,
                типов данных всего 8. А <span>1000</span> - это 8 в двоичной
                системе счисления ! РИСКУЙ ! Просто доверься мне {namePlayer}!!!
              </p>
            </div>
          )) ||
      ...
      >
        ...
        {(buttle === 0 && (
          ...
          (buttle === 11 && plusAnswer[2] === true && (
            <div className={styles.textBadRobot}>
              Это был вопрос сложнее, ты начинаешь меня ЗЛИТЬ !
            </div>
          )) ||
          ...
          (buttle === 24 && plusAnswer[6] === true && (
            <div className={styles.textBadRobot}>
              НЕ ЗНАЮ КАК ТЫ ЭТО ДЕЛАЕШЬ... ЛАДНО ГОТОВЬСЯ К ПОРАЖЕНИЮ !
            </div>
          )) ||
